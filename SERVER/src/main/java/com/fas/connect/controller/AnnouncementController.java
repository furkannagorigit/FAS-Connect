...
public class AnnouncementController {
    ...
    @GetMapping
    public ResponseEntity<List<PostRequestDTO>> getAllAnnouncements() {
        List<PostRequestDTO> announcementDTOs = announcementService.getAllAnnouncements();
    ...
    public ResponseEntity<?> addAnnouncement(@RequestBody  PostRequestDTO announcementDTO,@PathVariable Long userId) {
//        	System.out.println(announcementDTO.toString());
    ...
    public ResponseEntity<?> editAnnouncement(@RequestBody  PostRequestDTO announcementDTO,@PathVariable Long postId) {
    	System.out.println(announcementDTO.toString());
